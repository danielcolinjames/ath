...
exports.default = getImagePalette;
...
var _lodash5 = require("lodash.sortby");

var _lodash6 = _interopRequireDefault(_lodash5);

var _colorThief = require("./color-thief");
...
function getRGBRange(color) {
  var rgb = (0, _lodash6.default)(color.rgb().array()).reverse();
...
function getColorPalette(image, colorThief) {
  ...
  return colorThief.getPalette(image).map(function (color) {
    var colorWrapper = new _color2.default(color.rgb);
...
function getImagePalette(image, colorThief) {
  colorThief = colorThief || new _colorThief2.default();
