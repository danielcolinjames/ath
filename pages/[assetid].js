...
const AssetPage = ({
  ...
  // name
  url.searchParams.append("n", assetInfo[0].name);
  // ticker
  url.searchParams.append("t", assetid.toUpperCase());
  // image
  url.searchParams.append("i", assetInfo[0].image);
  // r
            ...
            {hasAth ? (
              <>
                ...
                <p className="pt-8 pb-5 text-lg md:text-2xl font-ath font-normal text-black max-w-md md:max-w-xl">
                  {`The all-time highest price ever paid for ${
                    assetInfo[0].name
                  } was ${formatNumber(
                    ath
                    ...
                    if (index !== 0)
                      return (
                        <div className="pt-4" key={`shared-${index}`}>
                          ...
                          <p className="font-ath font-light text-lg text-gray-600">
                            Set <TimeAgo date={athTimestamp} suppressHydrationWarning />
                          </p>
                          ...
                          <div className="bg-white p-3 inline-block mt-4 border border-dotted border-gray-100">
                            <div className="flex flex-row items-center justify-start">
                              ...
                              >
                                Data accurate as of{" "}
                                <TimeAgo date={lastUpdated} suppressHydrationWarning/>
                              </a>
                            </div>
                          </div>
                        </div>
