...
import { getAssetColorsFromVibrantObj, rgbaStringFromRGBObj } from '../utils/colors'
...
const AssetPage = ({
  ...
  const athDate = hasAth ? format(athTimestamp as Date, 'MMMM do, yyyy') : 'an unknown date'
