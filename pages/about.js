        ...
        <div className="p-5 mx-auto max-w-4xl">
          ...
          <div className="pt-5 pb-10">
            ...
            <p className="text-md md:text-md font-sans text-gray-500 pt-3">
              Thanks for checking out the site! I built this as a side project
              to play with some frontend tools I wanted to learn.
            </p>
            <p className="text-md md:text-md font-sans text-gray-500 pt-3">
            ...
            <p className="text-md md:text-md font-sans text-gray-500 pt-3">
              ...
              at <span className="text-green-500">hey@ath.ooo</span>.
            </p>
          </div>
        </div>
      </div>
